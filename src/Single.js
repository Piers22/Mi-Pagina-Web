    ...
    return (
      <div className="single">
        <div className="messages-header icons-header">
          <div className="icon-container" onClick={() => handleTabClick('mensajes')}>
            <i className="fas fa-comments"></i>
            <span>Mensajes</span>
          </div>
          <div className="icon-container" onClick={() => handleTabClick('besos')}>
            <i className="fas fa-kiss-wink-heart"></i>
            <span>Besos</span>
          </div>
          <div className="icon-container" onClick={() => handleTabClick('favoritos')}>
